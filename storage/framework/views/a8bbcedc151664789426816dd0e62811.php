...
<body>
    <main class="page">
        <div class="nav-row">
            <a href="<?php echo e(url('/apt/production')); ?>" class="back-btn">
        ...
        <div class="shell">
            ...
            <form id="shiftForm" class="form-body" method="POST" action="<?php echo e(route('apt.management.shift.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-top-bar">
                    <p><?php echo e($canManageShift ? 'Completa los datos para iniciar el turno.' : 'Información del turno y lote en recepción.'); ?></p>
                    <span><?php echo e($canManageShift ? '* Campos obligatorios' : 'Solo lectura'); ?></span>
                </div>
                ...
                <div class="grid-3">
                    <div class="field-group">
                        <label>
                            ...
                            <select id="user_id" name="user_id" required <?php echo e(!$canManageShift ? 'disabled' : ''); ?> class="field-control">
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <option value="<?php echo e($u->id); ?>" data-position="<?php echo e($userPosition); ?>" <?php echo e($isSelected ? 'selected' : ''); ?>>
                                        <?php echo e($u->name); ?>
                        ...
                        <label>
                            ...
                            <select id="shift" name="shift" required <?php echo e(!$canManageShift ? 'disabled' : ''); ?> class="field-control">
                                <option value="">Seleccionar turno</option>
                                <?php $selectedShift = $latestRegistration ? $latestRegistration->shift : ''; ?>
                                <option value="Turno 1" <?php echo e($selectedShift == 'Turno 1' ? 'selected' : ''); ?>>Turno 1</option>
                                <option value="Turno 2" <?php echo e($selectedShift == 'Turno 2' ? 'selected' : ''); ?>>Turno 2</option>
                                <option value="Turno 3" <?php echo e($selectedShift == 'Turno 3' ? 'selected' : ''); ?>>Turno 3</option>
                                <option value="Turno 1A" <?php echo e($selectedShift == 'Turno 1A' ? 'selected' : ''); ?>>Turno 1A</option>
                                <option value="Turno 1B" <?php echo e($selectedShift == 'Turno 1B' ? 'selected' : ''); ?>>Turno 1B</option>
                            </select>
                        </label>
                    </div>
                    ...
                    <div class="field-group">
                        <label>
                            ...
                            <input type="text" id="position" name="position" value="<?php echo e($latestRegistration ? $latestRegistration->position : 'Automático'); ?>" readonly class="field-control">
                        </label>
                        <label>
                            <span class="field-label"><i class="fa-solid fa-box-open"></i> Lote en recepción</span>
                            <select id="lot_id" name="lot_id" required <?php echo e(!$canManageShift ? 'disabled' : ''); ?> class="field-control">
                                <option value=""><?php echo e($canManageShift ? 'Seleccionar lote' : ($lots->isEmpty() ? 'Sin lote asignado' : 'Lote asignado')); ?></option>
                                <?php $selectedLot = $latestRegistration ? $latestRegistration->lot_id : ''; ?>
                                <?php $__currentLoopData = $lots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($l->id); ?>" <?php echo e($selectedLot == $l->id ? 'selected' : ''); ?>>
                                        <?php echo e($l->folio); ?>
                    ...
                    <div class="field-group" style="justify-content: space-between;">
                        <div>
                            ...
                            <div class="date-box">
                                ...
                                <span><?php echo e($latestRegistration ? $latestRegistration->started_at->format('d/m/Y') : date('d/m/Y')); ?></span>
                            </div>
                        </div>
                        <?php if($canManageShift): ?>
                        ...
                        <?php else: ?>
                            <?php if($latestRegistration): ?>
                                <a href="<?php echo e(route('apt.management.activity')); ?>" class="btn-save" style="text-decoration: none;">
...
<?php /**PATH C:\xampp\htdocs\Proagroindustria\resources\views/production/management.blade.php ENDPATH**/ ?>